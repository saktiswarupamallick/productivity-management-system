...
import type { PgSession, PreparedQuery, PreparedQueryConfig, QueryResultHKT, QueryResultKind } from "../session.cjs";
...
export type PgUpdatePrepare<T extends AnyPgUpdate> = PreparedQuery<PreparedQueryConfig & {
